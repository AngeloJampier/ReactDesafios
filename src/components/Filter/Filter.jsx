...
const Filter = () => {
  ...
  const handleMinPrice = (event) =>
    setMinPrice(event.target.value === "" ? 0 : parseFloat(event.target.value));
  const handleValidPrice = () =>
    setValidPrice(minPrice <= maxPrice ? true : false);
      ...
      <div className="filterContainer">
        ...
        <FormControl fullWidth>
          ...
          >
            ...
            <MenuItem
              component={Link}
              to="/category/equiposdesonido"
              value={"equiposdesonido"}
            >
              Equipos de Sonido
            </MenuItem>
            <MenuItem
            ...
            <MenuItem component={Link} to="/category/laptops" value={"laptops"}>
              Laptops
            </MenuItem>
            <MenuItem component={Link} to="/category/moviles" value={"moviles"}>
              Moviles
            </MenuItem>
            <MenuItem
              component={Link}
        ...
        <div className="aditionalFiltersContainer">
          ...
          {!validPrice && (
            <FormHelperText style={{ color: "red", textAlign: "right" }}>
              Ingrese un rango de precio válido
            </FormHelperText>
          )}
        </div>
        <FormControl className="formControl" fullWidth>
